...
role :web, "whoru.com"                          # Your HTTP server, Apache/etc
role :app, "whoru.com"                         # This may be the same as your `Web` server
role :db,  "whoru.com"   , :primary => true # This is where Rails migrations will run
